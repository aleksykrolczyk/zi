...
public class Searcher {
    public static void main(String args[]) throws IOException, ParseException {
        ...
        TermQuery tq1;
        {
            ...
            String qMammal = analyzer.normalize(Constants.content, queryMammal).utf8ToString();
            term = new Term(Constants.content, qMammal);
        ...
        TermQuery tq2;
        {
            ...
            String qBird = analyzer.normalize(Constants.content, queryBird).utf8ToString();
            term = new Term(Constants.content, qBird);
        ...
        // Boolean query
        {
            ...
            BooleanClause mammalClause = new BooleanClause(tq1, BooleanClause.Occur.MUST);
            BooleanClause birdClause = new BooleanClause(tq2, BooleanClause.Occur.MUST);

            BooleanQuery.Builder builder = new BooleanQuery.Builder();
            builder.add(mammalClause);
            builder.add(birdClause);
        ...
        // For this reason, construct PrefixQuery.
        {
            ...
            term = new Term(Constants.filename, "ant");
        ...
        // which contain a term "eat?" "?" stand for any letter (* for a sequence of letters).
        {
            ...
            term = new Term(Constants.content, "eat?");
        ...
        // Which documents have been found?
        {
            ...
            term = new Term(Constants.content, "mamml?");
        ...
        // to query object, and find relevant documents. Analyze the outcomes.
        {
            ...
            Query q = queryParser.parse(selectedQuery);
